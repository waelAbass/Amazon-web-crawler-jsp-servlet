...
public class myser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       // String action = request.getParameter("action");
        List<product> list = dao.getallafter(pcategory, (page - 1) * recordsPerPage,
                    5);
         List<product> list1 = dao.getallbefore(pcategory, (page - 1) * recordsPerPage,
                    5);
            ...
            request.setAttribute("before", list1);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(myser.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
